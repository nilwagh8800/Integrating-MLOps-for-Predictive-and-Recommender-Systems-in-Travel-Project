...
Original file is located at
    https://colab.research.google.com/drive/1sRNq_dVLnrYqRzNOr8c5EoqtiipbHnKO
...
pickle.dump(best_elasticnet_model,open('/content/drive/MyDrive/travel_capstone/elasticnet_model.pkl','wb'))
...
rf_model=pickle.load(open('/content/drive/MyDrive/travel_capstone/rf_model.pkl','rb'))
